...
/*
Package chacha20 implements ChaCha20 stream cipher as specified in http://cr.yp.to/chacha/chacha-20080128.pdf

	* This package adapted from salsa20 package in https://godoc.org/golang.org/x/crypto/salsa20
	* This package will be removed as soon as Chacha20 officially supported.
*/
package chacha20
...
// contains the raw chacha20 counter bytes (both nonce and block counter).
